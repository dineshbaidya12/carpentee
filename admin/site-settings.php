        ...
        <div class="container-fluid">
            <div class="start-content">
                <form class="furniture-form" method="POST" enctype="multipart/form-data"
                    action="actions/general-setting.php">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="text" id="admin-name" name="admin_name" value="<?php echo $adminName ?? ''; ?>">
                    </div>

                    <div class="form-group">
                        <label for="username" class="form-label">Username</label>
                        <input class="form-control form-control-sm" type="text" id="username" name="username" value="<?php echo $username ?? ''; ?>">
                    </div>

                    <div class="form-group">
                        <label for="email" class="form-label">Admin Email</label>
                        <input class="form-control form-control-sm" type="text" id="email" name="email" value="<?php echo $email ?? ''; ?>">
                    </div>

                    <div class="form-group">
                        <label for="password" class="form-label">Password</label>
                        <input class="form-control form-control-sm" type="text" id="password" name="password" value="<?php echo $password ?? ''; ?>">
                    </div>

                    <div class="form-group">
                        <label for="phone" class="form-label">Phone</label>
                        <input class="form-control form-control-sm" type="text" id="phone" name="phone" value="<?php echo $phone ?? ''; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="text" id="site-name" name="site_name" value="<?php echo $siteName ?? ''; ?>">
                    </div>

                    <div class="form-group">
                        <label for="site-title" class="form-label">Site Title</label>
                        <input class="form-control form-control-sm" type="text" id="site-title" name="site_title" value="<?php echo $siteTitle ?? ''; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control form-control-sm" type="text" id="latitude" name="latitude" value="<?php echo $lat ?? ''; ?>">
                            </div>
                            <div class="col">
                                <label for="longitute" class="form-label">Longitute</label>
                                <input class="form-control form-control-sm" type="text" id="longitute" name="longitute" value="<?php echo $long ?? ''; ?>">
                            </div>
                        </div>
                    </div>
