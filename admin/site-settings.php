        ...
        <div class="container-fluid">
            ...
            <div class="start-content">
                ...
                <form class="furniture-form" method="POST" enctype="multipart/form-data" action="actions/general-setting.php">
                    ...
                    <h1 class="f_pass_heading">Forgot Password Security Questions Answer</h1>


                    <div class="form-group">
                        <?php
                        $fQuery = $mysqli->query("SELECT * FROM forgot_password");
                        ...
                        ?>
                                ...
                                <input type="text" class="form-control" id="question<?php echo $i; ?>" style="resize:none;" name="question<?php echo $i; ?>" maxlength="300" value="<?php echo $fResukt['question']; ?>">

                                <label for="answer<?php echo $i; ?>">Answer <?php echo $i; ?></label>

                                <textarea class="form-control" id="answer<?php echo $i; ?>" rows="2" style="resize:none;" name="answer<?php echo $i; ?>" maxlength="300"><?php echo $fResukt['answer']; ?></textarea>
...
if (isset($_SESSION['forgot_pass'])) {
    ...
    echo '<script>
        ...
        Swal.fire({
            ...
            text: "Please Update or write down Your Password",
